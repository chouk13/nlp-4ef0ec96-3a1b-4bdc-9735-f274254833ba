...
const PROJECT_NAME = "4ef0ec96-3a1b-4bdc-9735-";
...
const IDEA_BRIEF = "Tu es un expert en création de mini-SaaS viraux, ultra rentables, optimisés pour la pub et la scalabilité.\n\nTâche:\n- À partir de la tendance suivante, conçois un mini-SaaS complet.\n\nTendance:\n\"Nom du mini-SaaS : DanceMeAI\nPromesse principale : Transforme ta photo en une vidéo où tu danses la dernière trend TikTok en quelques secondes.\nPain point principal : Les utilisateurs veulent créer facilement des vidéos virales de danse sans savoir danser ni filmer.\nFonctionnalités clés :\n- Import rapide de photo avec détection automatique du sujet\n- Animation IA personnalisée sur les tendances de danse ";
